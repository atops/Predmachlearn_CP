...
Trying to be a little smarter about it, I made several exploratory plots, including box plots of each of the factors against the `classe` variable. Some of these are shown in the Appendix. These showed several outliers which were contained within only 3 observations. I threw those 3 observations out.
